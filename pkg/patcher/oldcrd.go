...
func OldZfsVolumesCrd() ([]byte, error) {
	return yaml.YAMLToJSON([]byte(`apiVersion: apiextensions.k8s.io/v1
...
func OldZfsSnapshotsCrd() ([]byte, error) {
	return yaml.YAMLToJSON([]byte(`apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
...
func OldZfsRestoresCrd() ([]byte, error) {
	return yaml.YAMLToJSON([]byte(`apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
metadata:
  annotations:
